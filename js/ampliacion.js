let parametros = new URLSearchParams(window.location.search) /* esto va a buscar los id de cada card */
let identificador = parametros.get('id') /* trae lo que tiene el id */
let producto = catalogo.at(identificador) /* -> let producto = cards.at(identificador) */
